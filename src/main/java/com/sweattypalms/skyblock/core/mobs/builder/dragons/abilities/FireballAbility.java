...
public class FireballAbility implements IDragonAbility {
    ...
    public void tick() {
        ...
        Vec3D headPos = dragon.bn.aG();
        Location headLoc = new Location(dragon.getBukkitEntity().getWorld(), headPos.a, headPos.b, headPos.c);
                ...
                for (int x = -1; x < 1; x++) {
                    for (int y = -1; y < 1; y++) {
                        for (int z = -1; z < 1; z++) {
                            ...
                            ParticleEffect.FLAME.display(0, 0, 0, 0, 0, loc, player);
                        }
                    }
                }
            });
