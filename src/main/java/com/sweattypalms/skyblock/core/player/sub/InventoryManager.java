...
public class InventoryManager extends PlayerManager {
    ...
    public SkyblockItem getSkyblockItemInHand() {
        ItemStack itemStack = this.skyblockPlayer.getPlayer().getInventory().getItemInHand();
    ...
    public HashMap<SkyblockItemType, ItemStack> getInventoryItems() {
        ...
        Arrays.stream(SkyblockItemType.values()).toList().forEach(skyblockItemType -> {
            ...
            ItemStack itemStack = switch (skyblockItemType.getSlot()) {
                case HAND -> this.skyblockPlayer.getPlayer().getInventory().getItemInHand();
                case HEAD -> this.skyblockPlayer.getPlayer().getInventory().getHelmet();
                case CHEST -> this.skyblockPlayer.getPlayer().getInventory().getChestplate();
                case LEGS -> this.skyblockPlayer.getPlayer().getInventory().getLeggings();
                case FEET -> this.skyblockPlayer.getPlayer().getInventory().getBoots();
                default -> this.skyblockPlayer.getPlayer().getInventory().getItemInHand();
            };
