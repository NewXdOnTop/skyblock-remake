...
public class StatsManager {
    ...
    public void initHealth() {
        ...
        AttributeInstance attribute = entityPlayer.getAttributeInstance(GenericAttributes.maxHealth);
        assert attribute != null;
        attribute.setValue(this.maxStats.get(Stats.HEALTH));
 ...
 */
    ...
    public void maxStats(Stats stat, double value) {
        ...
        if (maxStats >= liveStats && stat == Stats.HEALTH) {
            EntityPlayer entityPlayer = BukkitWrapper.getHandle(this.player.getPlayer());
            AttributeInstance attribute = entityPlayer.getAttributeInstance(GenericAttributes.maxHealth);
            assert attribute != null;
