...
import com.sweattypalms.skyblock.core.helpers.Tuple;
...
public class AxeOfTheShredded extends SkyblockItem implements IHasAbility {
    ...
    public static class ThrowAbility implements ITriggerableAbility, IUsageCost, ICooldown {
        ...
        public void apply(Event _e) {
            ...
            ArmorStand armorstand = player.getWorld().spawn(player.getLocation().add(0, 0.5, 0), ArmorStand.class);
            armorstand.setArms(true);
            armorstand.setGravity(false);
            armorstand.setVisible(false);
            MozangStuff.noHit(armorstand);
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    Block targetBlock = armorstand.getTargetBlock((Set<Material>) null, 1);

                    if (targetBlock != null && !targetBlock.getType().isTransparent()) {
                        armorstand.remove();
                        cancel();
                    }
